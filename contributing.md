...
```bash
git clone https://github.com/<username>/rehype-image-links
```

Next you need to install the dependencies.

```bash
cd rehype-image-links
npm install
```
...
[license]: https://github.com/bradgarropy/rehype-image-links/blob/master/license
[fork]: https://github.com/bradgarropy/rehype-image-links/fork
[contributors]: https://github.com/bradgarropy/rehype-image-links#-contributors
